    ...
    public function up(): void
    {
        ...
        if (! Schema::hasTable('menu')) {
            ...
            Db::table('menu')->insert([
                ['id' => 1, 'parent_id' => 0, 'name' => '系统管理', 'type' => MenuType::CATALOG, 'path' => '/system', 'component' => 'Layout', 'perm' => '', 'sort' => 1, 'visible' => BaseStatus::NORMAL, 'icon' => 'system', 'redirect' => '/system/platform', 'created_at' => $date, 'updated_at' => $date],
                ['id' => 2, 'parent_id' => 1, 'name' => '管理员管理', 'type' => MenuType::MENU, 'path' => 'platform', 'component' => 'system/platform/index', 'perm' => '', 'sort' => 1, 'visible' => BaseStatus::NORMAL, 'icon' => 'el-icon-User', 'redirect' => '', 'created_at' => $date, 'updated_at' => $date],
                ...
                ['id' => 6, 'parent_id' => 1, 'name' => '角色管理', 'type' => MenuType::MENU, 'path' => 'role', 'component' => 'system/role/index', 'perm' => '', 'sort' => 1, 'visible' => BaseStatus::NORMAL, 'icon' => 'role', 'redirect' => '', 'created_at' => $date, 'updated_at' => $date],
                ...
                ['id' => 11, 'parent_id' => 1, 'name' => '菜单管理', 'type' => MenuType::MENU, 'path' => 'menu', 'component' => 'system/menu/index', 'perm' => '', 'sort' => 1, 'visible' => BaseStatus::NORMAL, 'icon' => 'menu', 'redirect' => '', 'created_at' => $date, 'updated_at' => $date],
