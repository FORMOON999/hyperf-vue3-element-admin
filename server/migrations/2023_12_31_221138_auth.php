    ...
    public function up(): void
    {
        ...
        if (! Schema::hasTable('menu')) {
            ...
            Db::table('menu')->insert([
                ...
                ['id' => 19, 'parent_id' => 2, 'name' => '重置密码', 'type' => MenuType::BUTTON, 'path' => '', 'component' => '', 'perm' => 'sys:platform:password:reset', 'sort' => 4, 'visible' => BaseStatus::NORMAL, 'icon' => '', 'redirect' => '', 'created_at' => $date, 'updated_at' => $date],
